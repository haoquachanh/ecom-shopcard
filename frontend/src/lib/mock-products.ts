...
export const mockProductTypes: ProductType[] = [
  { id: 901, name: 'Standee acrylic', slug: 'standee-acrylic', description: 'Mẫu standee đế tròn', pricingConfig: {}, isActive: true },
  ...
  { id: 904, name: 'Motion card', slug: 'motion-card', description: 'Gợi chuyển động khi nghiêng', pricingConfig: {}, isActive: true },
];
...
export const mockSamples: Sample[] = Array.from({ length: 20 }, (_, index) => {
  ...
  return {
    ...
    tags: index % 3 === 0 ? ['Flip', 'Brand'] : index % 3 === 1 ? ['Depth', 'Gift'] : ['Motion', 'POSM'],
    isActive: true,
  };
});
